            ...
            try
            {
                ...
                using (var timingScope = new QueryTimingsScope())
                {
                    ...
                    else if (q.Select != null)
                    {
                        ...
                        irc    = new IncludeRevisionsCommand(database:Database, context:queryContext.Documents, pathsForRevisionsInDocuments: query.Metadata.RevisionIncludes?.RevisionsChangeVectorSet);
